...
\begin{aligned} 
\text{Rate of change} &=  \frac{\text{pop. in 2006}- \text{pop. in  2002}}{2006-2002}\\\\
&= 1,100\hspace{.04in} \text{people per year}
\end{aligned}
...
\begin{aligned}
  \text{Rate of Change}                         
  &=\frac{\text{Change in Output}}{\text{Change         
  in Input}}\\ \\
...
1.  A town has a population of 2,000 people at time $t=0$. In each of the following cases, write a formula for the population $P$, of the town as a function of year $t$. <br>
...
3.  Find the slope of the line connecting the points $(2,7)$ and $(2,11)$. Find the equation of this line. <br> <br>
...
5. Below is the graph of a linear function, $f(x)$. The function crosses the y-axis at the point $0,y$. Find the exact value of $y$. <br><br>
...
6.  An apartment manager keeps careful record of how the rent charged per unit corresponds to the number of occupied units in a large complex. See the table: <br><br> ![](images/h.jpeg){width="90%"}
