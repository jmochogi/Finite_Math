...
8.  An apartment manager keeps careful record of how the rent charged per unit corresponds to the number of occupied units in a large complex. The collected data is shown in the table below: <br> <br> ***Table Here***
![Elephant](images/h.jpeg)
