...
![Updated Feasible Region](images/a.jpeg){width="80%"}
...
1. For each description in exercises a-c, create a mixture table and write one or more resource constraint inequalities. The unknown to use for each product is given in parenthesis:
...
3.  Determine whether the points $(2,4)$ and/or $(10,6)$ are points of the feasible region in exercises 4, 5, and 6. <br>
...
5.  A linear programming problem has the following constraints: $x\ge0$, $y\ge0$, $5x-y\le15$, and $4y+x\le24$.
    ...
    b)  Sketch a graph of the feasible region.<br> 
